...
const PaymentMethod = ({
  ...
  const handleSubmit = () => {
    ...
    console.log("🔍 DEBUG: Sending data to parent", {
      method: selectedMethod,
      details: paymentDetails,
    });

    // Pass the latest values directly
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-teal-100">
              Choose how you'd like to pay for your permit
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-sm text-blue-800">
              ...
              {selectedMethod === "bank_transfer" && (
                <div>
                  ...
                  <p className="mt-2 text-xs">
                    Please include your application number in the transfer
                    notes.
                  </p>
                </div>
              )}
              ...
              {selectedMethod === "over_counter" && (
                <ul className="space-y-1">
                  <li>
                    1. Bring this reference number to your selected payment
                    center
                  </li>
