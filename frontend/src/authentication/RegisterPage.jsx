                ...
                <div className="max-w-md mx-auto w-full space-y-5 sm:space-y-6">
                  ...
                  <div className="text-center space-y-2 sm:space-y-3">
                    <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-teal-100 rounded-full">
                      <UserPlus className="w-7 h-7 sm:w-8 sm:h-8 text-teal-700" />
                    </div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-800">
                      Create Account
                    </h3>
                    <p className="text-sm sm:text-base text-gray-600">
                      Register for business permit services
                    </p>
                  </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <select
                            ...
                            value={form.role}
                            onChange={handleChange}
                            className="w-full px-4 py-3 bg-white/95 border-2 border-gray-300 rounded-lg transition-all duration-300 ease-out text-gray-700 text-sm sm:text-base focus:outline-none focus:border-teal-600 focus:bg-white focus:ring-2 focus:ring-teal-100 hover:bg-white hover:border-teal-500 hover:shadow-sm"
                            required
                          >
                  ...
                  <div className="text-center pt-3 sm:pt-4 space-y-1 sm:space-y-2">
                    <div className="text-xs text-gray-400">
                      ...
                      <p className="hidden sm:block">
                        Registration System v2.1.0 • Powered by DCSI
                      </p>
                      <p className="block sm:hidden">
                        Registration v2.1.0 • DCSI
                      </p>
                    </div>
                  </div>
                </div>
